...
class SehenswuerdigkeitControllerTest {
  ...
  void newSehenswuerdigkeit() {
    ...
    //then
    ArgumentCaptor<Sehenswuerdigkeit> sehenswuerdigkeitArgumentCaptor = ArgumentCaptor.forClass(Sehenswuerdigkeit.class);
 ...
 void editSehenswuerdigkeit() {
    //given
    Long id = 69L;
    Sehenswuerdigkeit temp = new Sehenswuerdigkeit(id, 95.123f, 78.456f, "nutzerEmail@mail.com",
            "Sehenswürdig","Eine Sehenswürdige Sehenswürdigkeit");
    Sehenswuerdigkeit temp2 = new Sehenswuerdigkeit(id, 90.000f, 75.000f, "nutzerEmail2@mail.com",
  ...
  void editSehenswuerdigkeitThrowsExceptionIfIdMismatch(){
    ...
    Sehenswuerdigkeit temp = new Sehenswuerdigkeit(69L, 95.123f, 78.456f, "nutzerEmail@mail.com",
            "Sehenswürdig","Eine Sehenswürdige Sehenswürdigkeit");
    Sehenswuerdigkeit temp2 = new Sehenswuerdigkeit(420L, 90.000f, 75.000f, "nutzerEmail2@mail.com",
            "Sehenswürdig2","Noch eine Sehenswürdige Sehenswürdigkeit");
    underTest.newSehenswuerdigkeit(temp);
    //when
    //then
