    ...
    return args -> {
      ...
      Attraktion one = new Attraktion(
              ...
              "Das Lübecker Holstentor ist wohl das bekannteste Stadttor in Deutschland. Es wurde" +
                      " zwischen 1464 und 1478 von dem Lübecker Ratsbaumeister Hinrich Helmstede bei einer Modernisierung der Befestigungsanlagen an der Traveseite erbaut."
      );
      list.add(one);
      Attraktion two = new Attraktion(
              10.230732061508025f, 54.41217026940215f, "brian.didTheJob@gmx.de", "Marine-Ehrenmal" +
              " Laboe", "Das Lübecker Holstentor ist wohl das bekannteste Stadttor in Deutschland. Es wurde zwischen 1464 und 1478 von dem Lübecker Ratsbaumeister Hinrich Helmstede bei einer Modernisierung der Befestigungsanlagen an der Traveseite erbaut."
      );
      list.add(two);
      Attraktion three = new Attraktion(
              8.941200474376009f,54.31506447239934f, "brian.didTheJob@gmx.de","Nationalpark" +
              "-Zentrum Multimar Wattforum","Das Multimar Wattforum in Tönning ist das größte Informationszentrum für den Nationalpark Schleswig-Holsteinisches Wattenmeer."
      );
      list.add(three);
      ...
      Attraktion five = new Attraktion(
              ...
              "Fehmarn","Das Meereszentrum Fehmarn ist ein Schauaquarium in Burg auf der Ostseeinsel Fehmarn."
      );
      list.add(five);
      ...
      Attraktion seven = new Attraktion(
              ...
              "Friedrichskoog","Erleben Sie die in Deutschland einmalige gemischte Haltung von Seehunden und Kegelrobben! Wir freuen uns auf Ihren Besuch!"
      );
      list.add(seven);
      Attraktion eight = new Attraktion(
              9.569216743829838f, 54.49705190997663f,  "brian.didTheJob@gmx.de","Wikinger Museum " +
              "Haithabu","Das Wikinger Museum Haithabu ist eines der bedeutendsten archäologischen Museen Deutschlands."
      );
      list.add(eight);
      Attraktion nine = new Attraktion(
              8.297606365267928f,54.90098700930191f,  "brian.didTheJob@gmx.de","Sylt-Aquarium",
              "Das Sylt Aquarium im Süden der Stadt Westerland auf Sylt ist ein zoologischer Garten, der sich auf Fische aus der Nordsee sowie tropische Fische aus Korallenriffen spezialisiert hat."
      );
      list.add(nine);
      Attraktion ten = new Attraktion(
              10.780061975161248f,54.07501846712684f,  "brian.didTheJob@gmx.de","","Der " +
